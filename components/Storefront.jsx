...
export default function Storefront() {
  ...
  return (
    <>
      <section id="shop" className="bg-[#F3EDE4] text-[#4A463F] pb-24 sm:pb-0">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 pt-6 pb-14">
          <div className="text-center">
            ...
            <div className="hidden sm:inline-flex mt-8 rounded-full border border-[#D9D0C3] overflow-hidden bg-[#F7F1E8]">
              <button
                type="button"
                onClick={() => setTab("men")}
              ...
              <div key={block.category}>
                ...
                <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                  {block.items.map((p) => (
                    <article
                      key={p.id}
                      className="rounded-2xl border border-[#D9D0C3] bg-[#F7F1E8] p-5 sm:p-6 hover:-translate-y-0.5 hover:shadow-[0_14px_40px_rgba(0,0,0,0.08)] transition"
                    >
                      <div className="flex items-start justify-between gap-4">
                        ...
                        <p className="text-[14px] text-[#6F685E] shrink-0">
                          €{p.price.toFixed(2)}
                        </p>
                      </div>
                      ...
                      <div className="mt-5 flex flex-col sm:flex-row sm:items-center gap-3">
                        {p.status === "active" ? (
                          ...
                          <a
                            ...
                            className="inline-flex justify-center px-5 py-2 rounded-full text-[12px] tracking-[0.16em] uppercase border border-[#D9D0C3] text-[#6B6256] hover:bg-[#EDE5DA] transition"
                          >
                            Notify me
                          </a>
                        )}
