  ...
  return (
    <div className="min-h-screen bg-neutral-100 text-neutral-900">
        ...
        <div className="max-w-6xl mx-auto px-4 grid md:grid-cols-2 gap-10">
          <div>
            ...
            <ul className="mt-4 space-y-2 text-sm">
              <li>Email: <a href="mailto:justtoprint76@gmail.com" className="underline">justtoprint76@gmail.com</a></li>
      ...
      <footer className="bg-neutral-900 text-neutral-400 border-t border-neutral-800">
        <div className="max-w-6xl mx-auto px-4 py-6 flex flex-col md:flex-row justify-between text-sm">
          <p>© {new Date().getFullYear()} JUSTTOPRINT</p>
          <div className="flex gap-4">
            <a href="/spedizioni" className="hover:text-white">Spedizioni & Resi</a>
            <a href="mailto:justtoprint76@gmail.com" className="hover:text-white">Contatti</a>
